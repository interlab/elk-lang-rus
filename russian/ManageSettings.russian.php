...
$txt['auto_admin_session'] = 'Начать сеанс администратора автоматически при входе в систему';
$txt['securityDisable'] = 'Отключить проверку пароля при входе в админку';
$txt['securityDisable_moderate'] = 'Отключить проверку пароля модератора при входе в раздел модерации';
...
$txt['enable_contactform'] = 'Включить страницу "Обратная связь"';
$txt['contact_form_disabled'] = 'Запретить';
$txt['contact_form_registration'] = 'Показывать только при регистрации';
$txt['contact_form_menu'] = 'Показывать в меню';
...
$txt['max_pm_recipients_note'] = '(0 без ограничений, администраторы освобождаются)';
$txt['compactTopicPagesEnable'] = 'Ограничить количество отображаемых страниц';
$txt['compactTopicPagesContiguous'] = 'Формат отображения нескольких страниц:';
...
$txt['core_settings_saved'] = 'Настройки были успешно сохранены';
...
$txt['likes_enabled'] = 'Включить кнопку "Нравится"';
$txt['likeMinPosts'] = 'Минимальное количество сообщений у пользователя, чтобы он мог лайкать сообщения';
...
$txt['cache_memcache'] = 'Настройка Memcache:';
...
$txt['setting_visual_verification_num_chars'] = 'Количество символов в проверочном изображении';
...
$txt['signature_always'] = 'Всегда';
$txt['signature_onlyfirst'] = 'Only the first of each member';
$txt['signature_never'] = 'Никогда';
...
$txt['groups_pm_send'] = 'Группы пользователей, которым разрешено отправлять личные сообщения';
$txt['pm_posts_verification'] = 'Количество сообщений, до которых пользователи должны пройти проверку при отправке личных сообщений';
$txt['pm_posts_verification_note'] = '(0 без ограничений, администраторы освобождаются)';
$txt['pm_posts_per_hour'] = 'Количество персональных сообщений, которое пользователь может отправить в течение часа';
...
$txt['custom_profile_reordered'] = 'Поля профиля успешно переупорядочены';
...
$txt['custom_profile_placement_standard'] = 'Стандартный';
...
$txt['core_settings_disabled'] = 'Запретить';
...
$txt['edit_languages'] = 'Изменить язык';
...
$txt['add_language_elk'] = 'Скачать из репозитория переводов ElkArte';
