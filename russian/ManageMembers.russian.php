...
$txt['membergroups_modify_parent'] = 'Изменить родительскую группу';
...
$txt['membergroups_edit_hidden_boardindex'] = 'Видимый - Помимо группового ключа';
...
$txt['membergroups_edit_group_type'] = 'Тип группы';
$txt['membergroups_edit_select_group_type'] = 'Выбрать тип группы';
...
$txt['membergroups_icon_count'] = 'Номер изображения иконки';
$txt['membergroups_icon_image'] = 'Название изображения иконки';
$txt['membergroups_icon_image_note'] = 'Вы можете загрузить свои изображения в директорию темы по умолчанию, чтобы использовать их здесь. <br />Разные изображения могут быть использованы в разных темах, просто дайте им одинаковые имена.';
$txt['membergroups_max_messages'] = 'Максимальное количество личных сообщений';
$txt['membergroups_max_messages_note'] = '0 - неограниченно';
$txt['membergroups_max_messages_desc'] = 'Здесь вы можете установить лимит личных сообщений которые пользователь может сохранить на сервере.<br />
Для того чтобы хранить неограниченное количество личных сообщений, установить значение 0';
...
$txt['membergroups_name'] = 'Название';
...
$txt['admin_browse_w_approve'] = 'Одобрить';
$txt['admin_browse_w_activate'] = 'Активировать';
$txt['admin_browse_w_delete'] = 'Удалить';
$txt['admin_browse_w_reject'] = 'Отклонить (Удалить)';
