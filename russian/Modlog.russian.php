...
$txt['modlog_action'] = 'Файл';
$txt['modlog_ip'] = 'IP адрес';
...
$txt['modlog_ac_unapprove_topic'] = 'Неутвержденная тема &quot;{topic}&quot; от пользователя &quot;{member}&quot;';
$txt['modlog_ac_approve'] = 'Одобрено сообщение &quot;{subject}&quot; в теме &quot;{topic}&quot; от пользователя &quot;{member}&quot;';
$txt['modlog_ac_unapprove'] = 'Неодобренное сообщение &quot;{subject}&quot; в теме &quot;{topic}&quot; от пользователя &quot;{member}&quot;';
...
$txt['modlog_ac_sticky'] = 'Главная тема &quot;{topic}&quot;';
$txt['modlog_ac_unsticky'] = 'Не главная тема &quot;{topic}&quot;';
...
$txt['modlog_moderation_log'] = 'Логи модерации';
...
$txt['modlog_remove'] = 'Удалить выбранные';
$txt['modlog_removeall'] = 'Удалить все';
$txt['modlog_remove_selected_confirm'] = 'Вы уверены, что хотите удалить выбранные записи журнала?';
$txt['modlog_remove_all_confirm'] = 'Вы уверены, что хотите полностью очистить журнал?';
$txt['modlog_go'] = 'Искать';
...
$txt['modlog_ac_ban_update'] = 'Редактировать бан:';
$txt['modlog_ac_ban_remove'] = 'Удалить бан:';
...
$txt['modlog_ac_database_backup'] = 'Резервное копирование данных участника {member}.';
$txt['modlog_ac_editing_theme'] = '{member} отредактировал тему.';
...
$txt['modlog_ac_approve_attach'] = 'Одобрено имя файла quot;{filename}&quot; в сообщении &quot;{message}&quot;';
$txt['modlog_ac_remove_attach'] = 'Удалено неутвержденное имя файла &quot;{filename}&quot в сообщении &quot;{message}&quot;';
