...
$txt['permissions_profile_edit'] = 'Изменение профилей';
...
$txt['permissions_general'] = 'Права доступа по группам';
...
$txt['permissiongroup_general'] = 'Общие настройки';
...
$txt['permissionname_profile_set_avatar'] = 'Выберите аватарку';
$txt['permissionhelp_profile_set_avatar'] = 'If enabled this will allow a user to select an avatar.';

$txt['permissiongroup_general_board'] = 'Общие настройки';
...
$txt['permissiongroup_topic'] = 'Удаление и перенос тем';
...
$txt['permissiongroup_post'] = 'сообщений';
...
$txt['permission_enable_deny'] = 'Включить использование запрещающих прав для групп';
...
$txt['permission_enable_postgroups'] = 'Включить использование прав для групп, основанных на количестве сообщений';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
