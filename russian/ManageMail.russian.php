...
$txt['mail_settings'] = 'Параметры почты';
...
$txt['mail_period_limit'] = 'Максимальное количество отправляемых сообщений в минуту';
$txt['mail_period_limit_desc'] = '(0 &mdash; запретить)';
$txt['mail_batch_size'] = 'Максимальное количество сообщений на странице';

$txt['mailqueue_stats'] = 'Статистика очереди сообщений';
$txt['mailqueue_oldest'] = 'Старые сообщения';
$txt['mailqueue_oldest_not_available'] = 'нет данных';
