...
$txt['profile_info'] = 'Дополнительные подробности';
$txt['profile_contact'] = 'Контактная информация';
$txt['profile_moderation'] = 'Информация о предупреждениях';
$txt['profile_more'] = 'Подпись';
$txt['profile_attachments'] = 'Последние вложения';
$txt['profile_attachments_no'] = 'У пользователя нет ни одного вложения';
$txt['profile_recent_posts'] = 'Последние сообщения';
$txt['profile_posts_no'] = 'У пользователя нет ни одного сообщения';
$txt['profile_topics'] = 'Непросмотренные темы';
$txt['profile_topics_no'] = 'У пользователя нет ни одной темы';
$txt['profile_buddies_no'] = 'Ваш список друзей пуст';
$txt['profile_user_info'] = 'Информация о пользователе';
$txt['profile_contact_no'] = 'У этого пользователя не указана контактная информация';
$txt['profile_signature_no'] = 'У пользователя нет подписи';
$txt['profile_additonal_no'] = 'У этого пользователя не указана дополнительная информация';
$txt['profile_user_summary'] = 'Профиль';
$txt['profile_action'] = 'Текущий';
$txt['profile_recent_activity'] = 'Последняя активность';
$txt['profile_activity'] = 'Активность';
$txt['profile_loadavg'] = 'Пожалуйста, попробуйте немного позже. Эта информация пока недоступна из-за высокой нагрузки на сайт.';

$txt['change_profile'] = 'Изменить профиль';
$txt['preview_signature'] = 'Предпросмотр подписи';
$txt['current_signature'] = 'Текущий вариант подписи';
...
$txt['avatar_by_url'] = 'Укажите ссылку URL на свой аватар. (например: <em>http://www.mypage.com/mypic.png</em>)';
$txt['my_own_pic'] = 'Укажите ссылку (URL) на аватар';
$txt['gravatar'] = 'Граватара';
...
$txt['change'] = 'Сменить тему оформления';
...
$txt['auto_notify'] = 'Включить уведомление сразу после создания новой темы, либо после ответа в темe.';
...
$txt['notify_send_type_only_replies_pbe'] = 'Все сообщения';
$txt['notify_send_type_nothing'] = 'никогда';
$txt['notify_send_body'] = 'При отправке уведомления о новом сообщении в теме, отправить письмо на электронную почту (но, пожалуйста, не отвечайте на эти письма.)';
...
$txt['notifications_boards_update'] = 'Обновление';
$txt['notifications_update'] = 'Не уведомлять';
...
$txt['deleteAccount_none'] = 'Нет';
$txt['deleteAccount_all_posts'] = 'Только ответы';
...
$txt['viewWarning_help'] = 'Этот раздел позволяет просматривать все предупреждения, выданные этому участнику.';
...
$txt['trackIP'] = 'IP адрес';
$txt['trackLogins'] = 'Логины';

$txt['likes_show'] = 'Показать лайки';
$txt['likes_given'] = 'Сообщения, которые вы лайкнули';
$txt['likes_profile_received'] = 'полученные';
$txt['likes_profile_given'] = 'поставленные';
$txt['likes_received'] = 'Ваши темы, лайкнутые другими';
$txt['likes_none_given'] = 'У вас нет лайков к вашим темам';
$txt['likes_none_received'] = 'Нет никого кто бы лайкнул эту тему :\'(';
$txt['likes_confirm_delete'] = 'Удалить этот лайк?';
$txt['likes_show_who'] = 'Показать пользователей, которые лайкнули эту тему';
$txt['likes_by'] = 'Лайкнуто';
$txt['likes_delete'] = 'Удалить';
...
$txt['contactprefs'] = 'Обмен сообщениями';
...
$txt['use_sidebar_menu'] = 'Использовать боковое меню вместо выпадающего.';
$txt['use_click_menu'] = 'Кликните по выпадающему меню и выберите пункт';
...
$txt['hide_poster_area'] = 'Скрыть место информационного постера';
...
$txt['use_editor_quick_reply'] = 'Использовать полноценный редактор для быстрого ответа.';
...
$txt['show_attach_filename'] = 'Имя файла';
$txt['show_attach_downloads'] = 'Скачано';
$txt['show_attach_posted'] = 'Сохранено';
...
$txt['showPermissions_general'] = 'Права доступа по группам';
...
$txt['profile_view_warnings'] = 'Показать предупреждения';
$txt['profile_issue_warning'] = 'Предупреждения';
$txt['profile_warning_level'] = 'Уровень предупреждения';
...
$txt['profile_warning_name'] = 'Отображаемое имя пользователя';
...
$txt['profile_warning_errors_occurred'] = 'Предупреждение не было сделано по следующим причинам';
...
$txt['receive_from'] = 'Пользователи, разрешившие контактировать с ними';
$txt['receive_from_everyone'] = 'от всех пользователей';
$txt['receive_from_ignore'] = 'от всех пользователей, за исключением игнорируемых';
$txt['receive_from_admins'] = 'только от администраторов';
$txt['receive_from_buddies'] = 'только от друзей и администраторов';
...
$txt['pm_remove_inbox_label'] = 'Удалить метку Входящие при применении другой метки.';
...
$txt['history'] = 'История';
$txt['history_description'] = 'Данный раздел позволяет отслеживать действия пользователя, а также его IP адрес и историю посещения.';
