...
$txt['pm_error_data_limit_reached'] = 'ЛС не может быть отправлено \'%1$s\' так как его папка полна.';
...
$txt['pm_mark_unread'] = 'Пометить непрочитанным';

// Message Pruning.
$txt['pm_prune'] = 'Дерево сообщений';
$txt['pm_prune_desc'] = 'Удалить все личные сообщения старше, чем %1$sдней.';
...
$txt['pm_actions_filter_by_label'] = 'Фильтровать по метке';
...
$txt['pm_report_title'] = 'Пожаловаться на личное сообщение';
...
$txt['pm_search_sent_only'] = 'Искать только в отправленных.';
...
$txt['pm_visual_verification_desc'] = 'Пожалуйста, введите код на изображении выше, чтобы отправить это ЛС.';

$txt['pm_settings'] = 'Изменить настройки';
$txt['pm_change_view'] = 'Сменить вид';

$txt['pm_manage_rules'] = 'Управление правилами';
...
$txt['pm_add_rule'] = 'Добавить новое правило';
$txt['pm_apply_rules'] = 'Применить правило сейчас';
// Use entities in the below string.
$txt['pm_js_apply_rules_confirm'] = 'Вы уверены, что хотите применить текущие фильтры ко всем личным сообщения?';
$txt['pm_edit_rule'] = 'Изменить правило';
$txt['pm_rule_save'] = 'Сохранить правило';
$txt['pm_delete_selected_rule'] = 'Удалить выбранные правила';
// Use entities in the below string.
...
$txt['pm_rule_criteria_add'] = 'Добавить критерий';
$txt['pm_rule_criteria_pick'] = 'Выберите критерий';
$txt['pm_rule_mid'] = 'Имя отправителя';
$txt['pm_rule_gid'] = 'Группа отправителя';
$txt['pm_rule_sub'] = 'Тема сообщения содержит';
$txt['pm_rule_msg'] = 'Текст сообщения содержит';
$txt['pm_rule_bud'] = 'Отправитель - это ваш друг';
$txt['pm_rule_sel_group'] = 'Выбрать группу';
$txt['pm_rule_logic'] = 'При проверке критериев';
...
$txt['pm_rule_sel_action'] = 'Выберите действие';
...
$txt['pm_rule_too_complex'] = 'Правило, которое вы создаете, слишком велико для сохранения. Попробуйте разбить его на более мелкие правила.';
